...
class UserPublicationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.publikasi.jurnal', compact('publications', 
            'orcidCount',
            'scopusCount',
            'googleScholarCount',
            'garudaCount',
    ...
    public function showByResearcher(Researcher $researcher)
    {
        ...
        return view('frontend.publikasi.jurnalbysearch', compact(
            'researcher',
            'orcidPublications',
            'scopusPublications',
    ...
    {
        return view('frontend.publikasi.jurnal', [
    ...
    public function search(Request $request, Researcher $researcher)
    {
        ...
        return view('frontend.publikasi.jurnalbysearch', compact('researchers', 
            'query',
            'orcidPublications',
            'scopusPublications',
            'googleScholarPublications',
    ...
    public function listResearchers()
    {
        ...
        return view('frontend.researcher.researchers', compact('researchers'));
    }

    public function showResearcherDetail(Researcher $researcher)
    {
        $researcher->load('user', 'department.institution');
        return view('frontend.publikasi.jurnalbysearch', compact('researcher'));
    }
