...
class ResearcherProjectController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($hasInProgress) {
            return redirect()->route('researchers.projects.index')
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('researchers.projects.index')->with('success', 'Pengajuan proyek berhasil. Menunggu persetujuan admin.');
    }

    public function show($id)
    {
        $project = Project::where('created_by', auth()->id())->findOrFail($id);
        return view('researchers.projects.show', compact('project'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('researchers.projects.edit', compact('project'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('researchers.projects.index')->with('success', 'Proyek berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('researchers.projects.index')->with('success', 'Pengajuan proyek berhasil dihapus.');
    }
    ...
    public function submitPublication($id)
    {
        ...
        return view('researchers.projects.formsubmit', compact('project'));
    }
    ...
    public function storePublication(Request $request, $id)
{
    ...
    $publication = Publication::create([
        ...
        'doi' => $request->doi,
        'publication_date' => $request->publication_date, // ✅ diperbaiki
        'source' => 'TSTH2',
