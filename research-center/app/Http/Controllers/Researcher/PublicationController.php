...
class PublicationController extends Controller
{
    ...
    public function syncPublications($researcherId)
    {
        ...
        try {
            ...
            return redirect()->back()->with('error', 'Gagal mengambil data publikasi: ' . $e->getMessage());
        }

        if (empty($allPublications)) {
            return redirect()->back()->with('info', 'Tidak ada publikasi baru yang ditemukan.');
        }

        return redirect()->route('researcher.publications')->with('success', 'Publikasi berhasil disinkronkan.');
    }
    ...
    public function index()
    {
        ...
        return view('researcher.publication', [
