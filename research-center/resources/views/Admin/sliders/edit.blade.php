...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form id="slider-form" action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" id="old-description" value="{{ old('description', $slider->description) }}">
                ...
                <div class="mb-3">
                    ...
                    @if ($slider->image)
                        <small class="d-block mt-1">
                            Gambar saat ini: <a href="{{ asset('storage/' . $slider->image) }}" target="_blank">Lihat</a>
                        </small>
                    @endif
                ...
                <div class="mb-3">
                    ...
                    <select name="active" id="active" class="form-select">
                        ...
                        <option value="0" {{ old('active', $slider->active) == '0' ? 'selected' : '' }}>Nonaktif</option>
                    </select>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary" id="submit-btn">Perbarui</button>
                </div>
            </form>
        </div>
    </div>
