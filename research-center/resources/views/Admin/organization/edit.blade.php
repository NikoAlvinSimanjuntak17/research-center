    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="organization-form" action="{{ route('admin.organization.update', $organizationStructure->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            @if($organizationStructure->photo)
                                <img src="{{ asset('storage/'.$organizationStructure->photo) }}" alt="Organisasi Image" class="img-thumbnail mt-2" style="max-width: 200px;">
                            @endif
                            @error('photo')
                        ...
                        <div id="document_editor_empty" class="document-editor">
                            ...
                            <div class="document-editor-editable border rounded p-3" style="min-height: 300px;">
                                {!! old('description', $organizationStructure->description) !!}
                            </div>
                            @error('description')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
