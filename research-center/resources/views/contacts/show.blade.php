@extends('layout.backend.main', ['activePage' => 'contact.show', 'titlePage' => __('Detail Kontak')])
...
<div class="card">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between">
            ...
            <a href="{{ route('contact.edit', $contact->id) }}" class="btn btn-warning">Edit Kontak</a>
        </div>
    </div>
</div>
@endsection
