@extends('layout.backend.main', ['activePage' => 'contact.index', 'titlePage' => __('Daftar Kontak')])
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('contact.create') }}" class="btn btn-primary btn-sm">Tambah Kontak</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <form action="{{ route('contact.destroy', $contact->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus kontak ini?')">
                                    @csrf
                                    @method('DELETE')
