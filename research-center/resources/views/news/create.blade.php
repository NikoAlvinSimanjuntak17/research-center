@extends('layout.backend.main', ['activePage' => 'news.create', 'titlePage' => __('Create Berita')])
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-body">
                <center>
                    <h4 class="card-title">DATA BERITA & INFORMASI</h4>
                </center>
                <p align="left">
                ...
                <form action="{{route('news.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <center>
                            <button type="submit" class="btn btn-success"><i class="ph-paper-plane-tilt me-2"></i>SIMPAN DATA BERITA</button>
