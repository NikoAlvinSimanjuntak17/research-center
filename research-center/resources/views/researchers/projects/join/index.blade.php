...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        @else
            @include('researchers.projects.join._table', ['projects' => $joinedProjects, 'canJoin' => false])
        @endif
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        @else
            @include('researchers.projects.join._table', ['projects' => $availableProjects, 'canJoin' => true])
        @endif
    </div>
</div>
