	...
	<div class="offcanvas offcanvas-end" tabindex="-1" id="notifications">
		...
		<div class="offcanvas-body p-0">
			...
			<div class="p-3">	
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="{{ asset('admin/assets2/images/demo/users/face1.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
				...
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="{{ asset('admin/assets2/images/demo/users/face3.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
					...
					<div class="flex-fill">
						...
						<div class="d-flex my-2">
							<a href="#" class="status-indicator-container me-1">
								<img src="{{ asset('admin/assets2/images/demo/users/face10.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-danger"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="{{ asset('admin/assets2/images/demo/users/face11.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="{{ asset('admin/assets2/images/demo/users/face12.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="{{ asset('admin/assets2/images/demo/users/face13.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
			...
			<div class="p-3">
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="{{ asset('admin/assets2/images/demo/users/face25.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
						<span class="status-indicator bg-success"></span>
					</a>
					<div class="flex-fill">
				...
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="{{ asset('admin/assets2/images/demo/users/face24.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
					...
					<div class="flex-fill">
						...
						<div class="bg-light rounded p-2 my-2">
							<div class="d-flex align-items-center">
								<div class="me-2">
									<img src="{{ asset('admin/assets2/images/icons/pdf.svg')}}" width=)34" height="34" alt="">
								</div>
								<div class="flex-fill">
									new_contract.pdf
				...
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="{{ asset('admin/assets2/images/demo/users/face4.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
						<span class="status-indicator bg-danger"></span>
					</a>
					<div class="flex-fill">
