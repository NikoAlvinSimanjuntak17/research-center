        ...
        <div class="container relative z-index-1000">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="col-lg-10 lead">Temukan berbagai profile penelitian kami yang inovasi dan terpecaya.</p>
                </div>
            </div>
        </div>
...
<div class="blog-single-area pt-120 pb-120">
    <div class="container" style="margin-top: 7em">
        ...
        {{-- Daftar Sejarah --}}
    <div class="mb-5">
        <h3 class="text-center mb-4">Taman Sains Teknologi Herbal dan Hortikultura (TSTH2)</h4>
        ...
        <div class="blog-single-wrapper">
            <div class="blog-single-content">
                ...
                <div class="blog-details" style="margin-bottom: 5em;">
                    <h2 class="blog-details-title text-center mb-4">{{ $model->title }}</h2>
                    <div class="content">
                        {!! $model->description !!}
                    </div>
                    <hr>
        ...
        @else
            <p class="text-center text-muted">Tidak ada konten sejarah yang tersedia.</p>
        @endif
