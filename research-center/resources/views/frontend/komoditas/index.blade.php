...
@extends('layout.frontend.main', ['activePage' => 'Komoditas', 'titlePage' => __('Komoditas')])
            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="crumb">
                        ...
                        <li class="active">{{ Translator::translate('Komoditas', $locale, 'id') }}</li>
                    </ul>
                    <h1 class="text-uppercase">{{ Translator::translate('Komoditas', $locale, 'id') }}</h1>
            ...
            <div class="row g-4 mb-3 align-items-center justify-content-center">
                <div class="col-lg-6 text-center">
                    ...
                    <h2 class="text-uppercase wow fadeInUp" data-wow-delay=".2s">
                        {{ Translator::translate('FOKUS KOMODITAS', $locale, 'id') }}
            ...
            <div class="bg-color text-light rounded-1 overflow-hidden" style="height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
                <div class="hover relative overflow-hidden text-light text-center">
                    ...
                    <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                        <a class="btn-line" href="{{ route('frontend-komoditas.view', $item->id) }}">
