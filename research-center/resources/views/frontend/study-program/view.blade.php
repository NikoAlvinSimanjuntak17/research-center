@extends('layout.frontend.main', ['activePage' => 'frontend-study-program.view', 'titlePage' => __('View Program Studi')])
                        ...
                        <div class="widget category">
                            ...
                            <div class="category-list">
                                @foreach ($model_all as $value)
                                    <a href="{{route('frontend-study-program.view',['id'=>$value->id])}}"><i class="far fa-arrow-right"></i>{{$value->title}}</span></a>
                                @endforeach
