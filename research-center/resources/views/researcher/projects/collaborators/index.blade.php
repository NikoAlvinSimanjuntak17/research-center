                    ...
                    <table class="table table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('researcher.projects.collaborators.show', ['projectId' => $project->id, 'userId' => $collaborator->user_id]) }}" class="btn btn-info btn-sm" title="Detail">
                                        <i class="ph-eye"></i>
                                    </a>
                                    
                                    @if($collaborator->status === 'pending')
                                    <form action="{{ route('researcher.projects.collaborators.update-status', [$project->id, $collaborator->user_id]) }}" method="POST" style="display:inline;">
                                        @csrf
                                         @method('PUT') {{-- ini juga --}}
                                    ...
                                    <form action="{{ route('researcher.projects.collaborators.remove', [$project->id, $collaborator->user_id]) }}" 
