        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('researcher.projects.create') }}" class="btn btn-primary">Tambah Proyek</a>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('researcher.projects.edit', $project->id) }}" class="btn btn-warning btn-sm" title="Edit">
                                            <i class="ph-pencil"></i>
                                        </a>

                                        <form action="{{ route('researcher.projects.destroy', $project->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus proyek ini?')">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <a href="{{ route('researcher.projects.submit-publication', $project->id) }}" class="btn btn-success btn-sm" title="Selesaikan Proyek">
                                            <i class="ph-check"></i>
                                        </a>
                                        @endif
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p class="text-danger"><strong>Alasan Penolakan: 
                                            <br>
                                        </strong> {{ $project->rejection_reason ?? '-' }}</p>
                                        @endif
                                    </div>
