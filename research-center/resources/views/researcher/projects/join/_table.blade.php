    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="badge bg-{{ $project->pivot->status === 'approved' ? 'success' : ($project->pivot->status === 'pending' ? 'warning' : 'danger') }}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <ul>
                                ...
                                {{-- Alasan Penolakan --}}
                                @php
                                $currentCollab = $project->collaborators->firstWhere('user_id', auth()->id());
                                @endphp

                                @if ($currentCollab && $currentCollab->status === 'rejected' && $currentCollab->reason)
                                <div class="alert alert-danger mt-3">
                                    <strong>Pengajuan Kamu Ditolak</strong><br>
                                    <small>Alasan: {{ $currentCollab->reason }}</small>
                                </div>
                                @endif
                            </ul>
                        </div>
