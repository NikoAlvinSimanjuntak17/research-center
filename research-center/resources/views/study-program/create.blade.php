@extends('layout.backend.main', ['activePage' => 'study-program.create', 'titlePage' => __('Create Program Studi')])
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('study-program.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <center>
                            <button type="submit" class="btn btn-success"><i class="ph-paper-plane-tilt me-2"></i>SIMPAN DATA PROGRAM STUDI</button>
