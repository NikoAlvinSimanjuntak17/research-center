...
<section class="page-header">
    ...
    <!-- /.page-header__bg -->
    <div class="container">
        <h2 class="page-header__title">Institutions</h2>
                ...
                <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='{{ $loop->index * 100 }}ms'>
                    <div class="blog-card__content">
                        <h3 class="blog-card__title">
                            <a href="{{ route('affiliations.detail', $institution->id) }}">
                                {{ $institution->name }}
                            </a>
                        </h3>
                        <div class="blog-card__content__btn">
                            <a href="{{ route('affiliations.detail', $institution->id) }}" class="blog-card__content__btn__link">
